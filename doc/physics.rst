...
.. math::
    ...
    a_{11}(u_1, v_1) + a_{12}(u_2, v_1) + a_{13}(p, v_1) + a_{14}(B_1, v_1)
        + a_{15}(B_2, v_1) &= l_1(v_1)\\
    a_{21}(u_1, v_2) + a_{22}(u_2, v_2) + a_{23}(p, v_2) + a_{24}(B_1, v_2)
        + a_{25}(B_2, v_2) &= l_2(v_2)\\
    a_{31}(u_1, q) + a_{32}(u_2, q) + a_{33}(p, q) + a_{34}(B_1, q)
        + a_{35}(B_2, q) &= l_3(q)\\
    a_{41}(u_1, C_1) + a_{42}(u_2, C_1) + a_{43}(p, C_1) + a_{44}(B_1, C_1)
        + a_{45}(B_2, C_1) &= l_4(C_1)\\
    a_{51}(u_1, C_2) + a_{52}(u_2, C_2) + a_{53}(p, C_2) + a_{54}(B_1, C_2)
        + a_{55}(B_2, C_2) &= l_5(C_2)
